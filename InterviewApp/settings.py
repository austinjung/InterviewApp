...
ADMINS = (
    ('Austin Jung', 'austinjung@live.ca'),
)
...
DATABASES = {
    'default': {
        ...
        'NAME': 'SampleISP_DB',                 # Or path to database file if using sqlite3.
...
SECRET_KEY = 'um+y)2%(uvzusr%g+%^-%k2i6km68u%406zx&amp;bzt-d41_57)2u'
...
TEMPLATE_DIRS = (
    ...
    # Always use forward slashes, even on Windows.
    # Don't forget to use absolute paths, not relative paths.
    'C:/home/src/InterviewApp/ProjectTemplates',
)
